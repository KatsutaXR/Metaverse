...
public class WorldUIView : MonoBehaviour
{
    ...
    public void Initialize(WorldData[] worldDatas, GameObject worldListItemPrefab)
    {
        CreateWorldListItems(worldDatas, worldListItemPrefab);
    }

    private void CreateWorldListItems(WorldData[] worldDatas, GameObject worldListItemPrefab)
    {
